...
# File Constants
LICENSE = Path("/data/data/com.termux/files/usr/share/common-licenses/GPL-3")
"""/data/data/com.termux/files/usr/share/common-licenses/GPL-3"""
NALA_SOURCES = Path("/data/data/com.termux/files/data/data/com.termux/files/usr/etc/apt/sources.list.d/nala-sources.list")
"""/data/data/com.termux/files/usr/data/data/com.termux/files/usr/etc/apt/sources.list.d/nala-sources.list"""
NALA_DIR = Path("/data/data/com.termux/files/usr/var/lib/nala")
"""/data/com.termux/files/usr/var/lib/nala"""
NALA_LOGDIR = Path("/data/data/com.termux/files/usr/var/log/nala")
"""/data/data/com.termux/files/usr/var/log/nala"""
NALA_DEBUGLOG = NALA_LOGDIR / "nala-debug.log"
"""/data/data/com.termux/files/usr/var/log/nala/nala.debug.log"""
DPKG_LOG = NALA_LOGDIR / "dpkg-debug.log"
"""/data/data/com.termux/files/usr/var/log/nala/dpkg-debug.log"""
DPKG_STATUS_LOG = NALA_LOGDIR / "dpkg-status.log"
"""/data/data/com.termux/files/usr/var/log/nala/dpkg-status.log"""
NALA_TERM_LOG = Path("/data/data/com.termux/files/usr/var/log/nala/term.log")
"""/data/data/com.termux/files/usr/var/log/nala/term.log"""
NALA_HISTORY = Path("/data/data/com.termux/files/usr/var/lib/nala/history.json")
"""/data/data/com.termux/files/usr/var/lib/nala/history.json"""
PACSTALL_METADATA = Path("/data/data/com.termux/files/usr/var/log/pacstall/metadata")
"""/data/data/com.termux/files/usr/var/log/pacstall/metadata"""
REBOOT_REQUIRED = Path("/data/data/com.termux/files/usr/var/run/reboot-required")
"""/data/data/com.termux/files/usr/var/run/reboot-required"""
REBOOT_PKGS = Path("/data/data/com.termux/files/usr/var/run/reboot-required.pkgs")
"""'/data/data/com.termux/files/usr/var/run/reboot-required.pkgs'"""
NEED_RESTART = Path("/data/data/com.termux/files/usr/var/run/needrestart")
"""/data/data/com.termux/files/usr/var/run/needrestart"""
...
"""/data/data/com.termux/files/usr/var/cache/apt/archives/partial"""
...
"""/data/data/com.termux/files/usr/var/lib/apt/lists/partial"""
PKGCACHE = Path(apt_pkg.config.find_dir("Dir::Cache::pkgcache"))
"""/data/data/com.termux/files/usr/var/cache/apt/pkgcache.bin"""
SRCPKGCACHE = Path(apt_pkg.config.find_dir("Dir::Cache::srcpkgcache"))
"""/data/data/com.termux/files/usr/var/cache/apt/srcpkgcache.bin"""
...
THIRD_PARTY_LICENSES = """Nala is licensed under the GPLv3 or later.
